...
download.file("http://alizaidi.blob.core.windows.net/training/yellow_tripdata_2015.xdf", 
              destfile = file.path(your_dir, 'yellow_tripdata_2015.xdf'))
```
...
```{r}
library(dplyrXdf)
taxi_xdf <- RxXdfData(file.path(your_dir, 'yellow_tripdata_2015.xdf'))
taxi_xdf %>% head
```
...
---
```{r}
taxi_transform <- RxXdfData("/datadrive/alizaidi/taxi_transform.xdf")
```
